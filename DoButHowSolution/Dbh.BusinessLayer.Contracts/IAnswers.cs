...
namespace Dbh.BusinessLayer.Contracts
{
    public interface IAnswers
    {
        ...
        IEnumerable<AnswerHeaderDTO> GetNotApprovedAnswers(int skip, int take);
        ...
        IEnumerable<AnswerHeaderDTO> GetAnswersOfUser(string username, int skip, int take);
        IEnumerable<AnswerHeaderDTO> GetRejectedAnswersOfUser(string username, int skip, int take);
